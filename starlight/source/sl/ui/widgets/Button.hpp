...
namespace sl
{
	...
	public:
		...
		///
		explicit Button(const sl::Rect<int>& bounds, const std::array<std::string, 3>& images);
		...
		///
		explicit Button(const int x, const int y, const std::string& text, const std::string& font, const std::array<ALLEGRO_COLOR, 3>& colors);

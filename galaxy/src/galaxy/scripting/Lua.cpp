...
namespace galaxy
{
	...
	namespace lua
	{
		void inject_galaxy_into_lua()
		{
			...
			config_type["getBool"]   = &core::Config::get<bool>;
			config_type["getInt"]    = &core::Config::get<int>;
			config_type["getFloat"]  = &core::Config::get<float>;
			config_type["getString"] = &core::Config::get<std::string>;

			auto guid_type         = lua.new_usertype<core::Guid>("Guid", sol::constructors<core::Guid()>());
			guid_type["as_string"] = &core::Guid::as_string;
			guid_type["is_empty"]  = &core::Guid::is_empty;
			lua.set_function("galaxy_make_guid", &core::Guid::make);
            ...
            fileinfo_type["path"] = &fs::FileInfo::m_path;
			...
			lua.set_function("encode_gzip", &math::encode_gzip);
			lua.set_function("decode_gzip", &math::decode_gzip);

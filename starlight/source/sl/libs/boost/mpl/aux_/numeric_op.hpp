...
#   include <sl/libs/boost/mpl/aux_/numeric_cast_utils.hpp>
...
#   include <sl/libs/boost/mpl/aux_/msvc_eti_base.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3,( BOOST_PP_DEC(AUX778076_OP_ARITY), 2, <sl/libs/boost/mpl/aux_/numeric_op.hpp> ))

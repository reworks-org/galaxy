...
namespace galaxy
{
	namespace input
	{
		    ...
		    : m_text_input {""}, m_inputting_text {false}
		{
			...
			m_keymap.emplace(Keys::NUM_1, GLFW_KEY_1);
			m_keymap.emplace(Keys::NUM_2, GLFW_KEY_2);
			m_keymap.emplace(Keys::NUM_3, GLFW_KEY_3);
			m_keymap.emplace(Keys::NUM_4, GLFW_KEY_4);
			m_keymap.emplace(Keys::NUM_5, GLFW_KEY_5);
			m_keymap.emplace(Keys::NUM_6, GLFW_KEY_6);
			m_keymap.emplace(Keys::NUM_7, GLFW_KEY_7);
			m_keymap.emplace(Keys::NUM_8, GLFW_KEY_8);
			m_keymap.emplace(Keys::NUM_9, GLFW_KEY_9);
			m_keymap.emplace(Keys::NUM_0, GLFW_KEY_0);
			...
			m_prev_key_states.emplace(Keys::NUM_1, GLFW_RELEASE);
			m_prev_key_states.emplace(Keys::NUM_2, GLFW_RELEASE);
			m_prev_key_states.emplace(Keys::NUM_3, GLFW_RELEASE);
			m_prev_key_states.emplace(Keys::NUM_4, GLFW_RELEASE);
			m_prev_key_states.emplace(Keys::NUM_5, GLFW_RELEASE);
			m_prev_key_states.emplace(Keys::NUM_6, GLFW_RELEASE);
			m_prev_key_states.emplace(Keys::NUM_7, GLFW_RELEASE);
			m_prev_key_states.emplace(Keys::NUM_8, GLFW_RELEASE);
			m_prev_key_states.emplace(Keys::NUM_9, GLFW_RELEASE);
			m_prev_key_states.emplace(Keys::NUM_0, GLFW_RELEASE);

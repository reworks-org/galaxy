...
namespace galaxy
{
	namespace ui
	{
		...
		void TextInput::create(std::string_view input_bg, std::string_view font, float border_width)
		{
			...
			m_box.create(input_bg, ORTHO_FAR_24BIT - 1);
			...
			m_cursor.create<graphics::Primitives::LINE>(data, ORTHO_FAR_24BIT);
		...
		void TextInput::render()
		{
			...
			if (m_draw_cursor && m_is_focus)
			{
				...
				RENDERER_2D().draw_line(&m_cursor, &m_cursor_transform);
			}

...
NK_API struct nk_context*   nk_glfw3_init(GLFWwindow *win, int max_vertex_buffer, int max_element_buffer);
NK_API void                 nk_glfw3_shutdown(void);
NK_API void                 nk_glfw3_font_stash_begin(struct nk_font_atlas **atlas);
NK_API void                 nk_glfw3_font_stash_end(void);
NK_API void                 nk_glfw3_new_frame(void);
NK_API void                 nk_glfw3_render(enum nk_anti_aliasing);
NK_API struct nk_glfw*      nk_glfw3_data();
...
nk_glfw3_init(GLFWwindow *win, int max_vertex_buffer, int max_element_buffer)
{
    glfw.win = win;

...
namespace galaxy
{
	namespace lua
	{
		...
		void register_res()
		{
			...
			auto tex_info_type      = lua->new_usertype<res::TextureAtlas::TextureInfo>("gTextureInfo", sol::constructors<res::TextureAtlas::TextureInfo()>());
			tex_info_type["path"]   = &res::TextureAtlas::TextureInfo::m_path;
			tex_info_type["region"] = &res::TextureAtlas::TextureInfo::m_region;
			...
			tex_atlas_type["build_from_json"] = &res::TextureAtlas::build_from_json;
			tex_atlas_type["create"]          = &res::TextureAtlas::create;
			tex_atlas_type["get_size"]        = &res::TextureAtlas::get_size;
			tex_atlas_type["get_tex_info"]    = &res::TextureAtlas::get_tex_info;

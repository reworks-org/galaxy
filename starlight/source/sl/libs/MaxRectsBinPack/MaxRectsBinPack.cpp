...
namespace rbp 
{
	...
	sl::Rect<int> MaxRectsBinPack::Insert(int width, int height, FreeRectChoiceHeuristic method)
	{
		sl::Rect<int> newNode;
	...
	void MaxRectsBinPack::Insert(std::vector<sl::Vector2<int>> &rects, std::vector<sl::Rect<int>> &dst, FreeRectChoiceHeuristic method)
	{
		dst.clear();
	...
	void MaxRectsBinPack::PlaceRect(const sl::Rect<int> &node)
	{
		size_t numRectanglesToProcess = freeRectangles.size();
		for (size_t i = 0; i < numRectanglesToProcess; ++i)
		{
	...
	sl::Rect<int> MaxRectsBinPack::ScoreRect(int width, int height, FreeRectChoiceHeuristic method, int &score1, int &score2) const
	{
		sl::Rect<int> newNode;
	...
	sl::Rect<int> MaxRectsBinPack::FindPositionForNewNodeBottomLeft(int width, int height, int &bestY, int &bestX) const
	{
		sl::Rect<int> bestNode;
		memset(&bestNode, 0, sizeof(sl::Rect<int>));
	...
	sl::Rect<int> MaxRectsBinPack::FindPositionForNewNodeBestShortSideFit(int width, int height,
	...
	sl::Rect<int> MaxRectsBinPack::FindPositionForNewNodeBestLongSideFit(int width, int height,
		int &bestShortSideFit, int &bestLongSideFit) const
	{
		sl::Rect<int> bestNode;
		memset(&bestNode, 0, sizeof(sl::Rect<int>));
	...
	sl::Rect<int> MaxRectsBinPack::FindPositionForNewNodeBestAreaFit(int width, int height,
	...
	sl::Rect<int> MaxRectsBinPack::FindPositionForNewNodeContactPoint(int width, int height, int &bestContactScore) const
	{
		sl::Rect<int> bestNode;
		memset(&bestNode, 0, sizeof(sl::Rect<int>));

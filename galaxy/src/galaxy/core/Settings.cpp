...
namespace galaxy
{
	auto Settings::set_config_to_default() -> void
	{
		...
		config.restore<std::string>("title", "game", "window");
		config.restore<bool>("vsync", false, "window");
		config.restore<bool>("resizable", true, "window");
		config.restore<bool>("decoration", true, "window");
		config.restore<bool>("fullscreen", false, "window");
		config.restore<bool>("maximized", false, "window");
		config.restore<bool>("minimized", false, "window");
		config.restore<bool>("borderless_fullscreen", false, "window");
		config.restore<std::string>("icon", "", "window");
		config.restore<bool>("on_top", false, "window");
		...
		config.restore<bool>("cursor_locked", false, "mouse");
	...
	auto Settings::set_settings_from_config() -> void
	{
		...
		s_decoration    = *config.get<bool>("decoration", "window");
		s_fullscreen    = *config.get<bool>("fullscreen", "window");
		s_maximized     = *config.get<bool>("maximized", "window");
		s_minimized     = *config.get<bool>("minimized", "window");
		s_borderless    = *config.get<bool>("borderless_fullscreen", "window");
		s_window_icon   = *config.get<std::string>("icon", "window");
		s_ontop         = *config.get<bool>("on_top", "window");
		...
		s_cursor_locked = *config.get<bool>("cursor_locked", "mouse");
	...
	auto Settings::decoration() noexcept -> bool
	{
		return s_decoration;
	}
	...
	auto Settings::minimized() noexcept -> bool
	{
		return s_minimized;
	}

	auto Settings::borderless_fullscreen() noexcept -> bool
	{
		return s_borderless;
	}
	...
	auto Settings::ontop() noexcept -> bool
	{
		return s_ontop;
	}
	...
	auto Settings::cursor_locked() noexcept -> bool
	{
		return s_cursor_locked;
	}

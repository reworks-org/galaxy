...
namespace galaxy
{
	...
	namespace graphics
	{
		...
		public:
			...
			///
			void create_default_batches(Texture* texture) noexcept;
			...
			///
			void draw_texture_to_target(graphics::VertexData* vertex_data, graphics::Texture* texture, const glm::mat4& transform, Shader* shader, RenderTexture* target);

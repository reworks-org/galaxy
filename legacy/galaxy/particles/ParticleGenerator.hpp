...
namespace galaxy
{
	...
	namespace components
	{
		...
		///
		class ParticleGenerator final : public fs::Serializable
		{
		...
		public:
			...
			/// \param emitter_y Set the y position of where to draw particles from.
			///
			void set_emitter(const float emitter_x, const float emitter_y) noexcept;
			...
			///
			/// Clear particle generator of data.
			///
			void clear();
			...
			///
			[[nodiscard]] graphics::ParticleInstance* const get_instance() noexcept;
		...
		private:
			...
			///
			robin_hood::unordered_map<std::string, graphics::ParticleInstance> m_particles_instances;

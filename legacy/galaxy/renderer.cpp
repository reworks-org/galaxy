#include "..\..\galaxy\src\galaxy\graphics\Renderer2D.hpp"
///
/// Renderer2D.cpp
/// galaxy
///
...
namespace galaxy
{
	namespace graphics
	{
		...
		void Renderer2D::create_default_batches(Texture* texture) noexcept
		{
			m_texture = texture;
		...
		void Renderer2D::draw_texture_to_target(graphics::VertexData* vertex_data, graphics::Texture* texture, const glm::mat4& transform, Shader* shader, RenderTexture* target)
		{

...
---
	...
	filter { "platforms:Linux32 or Linux64"}
		system "linux"
		includedirs { "starlight/source", "/usr/include/", "/usr/include/libxml2/", os.findheader("libxml2-dev"), os.findheader("liballegro5-dev"), os.findheader("libxml2"), os.findheader("allegro5") }

/*
 [auto_generated]
 sl/libs/boost/numeric/odeint/integrate/detail/integrate_const.hpp
...
#include <sl/libs/boost/numeric/odeint/iterator/integrate/detail/integrate_adaptive.hpp>

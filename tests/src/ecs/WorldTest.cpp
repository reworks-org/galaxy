...
TEST(ECS, AssignNameExistingEntity)
{
	galaxy::core::World m;
	auto e = m.create();
...
TEST(ECS, AssignNameNonExistantEntity)
{
	galaxy::core::World m;
	auto e = m.create();
	m.destroy(e);
...
TEST(ECS, FindFromNameNonExistant)
{
	galaxy::core::World m;

...
#ifndef QUASAR_SPRITES_HPP_
#define QUASAR_SPRITES_HPP_
...
{
	///
	/// Vertex shader for drawing sprites.
	///
	static inline std::string s_spriteVS = R""(
		#version 450 core
	...
	///
	/// Fragment shader for drawing sprites.
	///
	static inline std::string s_spriteFS = R""(
		#version 450 core

...
namespace re
{
	...
	public:
		...
		*/
	    virtual void Event(sf::Event& e, StateSystem* stateManager) = 0;
		...
		*/
	    virtual void Update(sf::Time dt, StateSystem* stateManager) = 0;
		...
		*/
	    virtual void Render(StateSystem* stateManager) = 0;
